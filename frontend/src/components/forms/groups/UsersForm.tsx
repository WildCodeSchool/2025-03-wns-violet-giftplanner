...
import { useDeleteGroupMutation, useRemoveMembersFromGroupMutation } from "../../../graphql/generated/graphql-types";
...
export default function UsersForm({query, setQuery, onAddTag, items, setFormData, errors, isAdmin, isEdit, groupId, currentUser, onSuccess, onRemoveMember}: handleUsersFormProps) {
    ...
    return (
        <div className="flex flex-col gap-4 px-20 m-auto">
            <SearchInput
              ...
              {isAdmin && isEdit && <Button colour="orange" onClick={deleteMyGroup}>Supprimer le groupe</Button> }
      </div>
