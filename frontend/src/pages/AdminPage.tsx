...
import { LuShieldCheck } from "react-icons/lu"; // ← Pour le bouton débannir
                        ...
                        <table className="admin-table">
                            ...
                            <tbody>
                                {filteredUsers.map((u) => (
                                    <tr
                                        key={u.id}
                                        className={u.isBanned ? "admin-user-banned" : ""}
                                    >
                                        <td>
                                            <img
                                                src={u.image_url || "/default.png"}
                                        ...
                                        <td>
                                            <span
                                                className={`admin-role ${u.isAdmin ? "admin-role-admin" : ""
                                                    }`}
                                            >
